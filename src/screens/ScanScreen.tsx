...
import { X, Flashlight, Image as ImageIcon, CheckCircle, Zap, Store, Coffee } from 'lucide-react';
...
export const ScanScreen: React.FC = () => {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Simulate scanning uploaded image - validate file name or content
    if (file.name.toLowerCase().includes('invalid') || file.name.toLowerCase().includes('random')) {
      validateAndProcessQr('https://random-website.example.com/not-a-payment');
    } else {
      validateAndProcessQr('sarie://pay?pa=star@sarie&pn=Star%20Supermarket&am=350', {
        id: 'merchant-qr-1',
