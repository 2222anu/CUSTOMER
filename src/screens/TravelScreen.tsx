...
import { Plane, Car, Hotel, Compass, X, Check, Calendar, Users, MapPin, ShieldCheck, ChevronRight } from 'lucide-react';
          ...
          >
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                <span style={{ fontSize: '12px', color: '#8E9BAE' }}>{isAr ? 'رقم الحجز (PNR)' : 'PNR / Booking Ref'}</span>
                <span style={{ fontSize: '13px', fontWeight: 900, color: 'var(--brand-green, #7FE87F)', fontFamily: 'monospace' }}>
