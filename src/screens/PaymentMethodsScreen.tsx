    ...
    <div className="fade-in">
      ...
      <div style={{ padding: '20px' }}>
        ...
        <ListRow
          ...
          rightElement={<span style={{ fontSize: '11px', color: 'var(--neon-primary)', fontWeight: '700' }}>Active</span>}
        ...
        <ListRow
          ...
          subLabel="**** 8821"
          rightElement={<span style={{ fontSize: '11px', color: 'var(--text-secondary)' }}>Linked</span>}
          onClick={() => navigateTo('BANK_ACCOUNTS')}
        />
